...
from LatentWeb import LatentWeb
from LatentAndroid import LatentAndroid
...
testunit.addTest(LatentWeb("testcase"))  #将测试用例加入到测试容器中
testunit.addTest(LatentWeb("testcase1"))  #将测试用例加入到测试容器中
testunit.addTest(LatentAndroid("testcase"))  #将测试用例加入到测试容器中
